...
//
//public class EmailAdapter RecyclerView.Adapter<EmailAdapter.MyViewHolder>{
//
//
...
//
//    @Override
//    public void onBindViewHolder(@NonNull final NewTimeSlotAdapter.MyViewHolder myViewHolder, int position) {
...
//        fetchBookedSlots();
//
//        if(!checkBookedSlot(position))
//        {           //if the slot is available/not booked
